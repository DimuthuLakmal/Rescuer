...
<html>
    <head>
        ...
        <title>Rescuer | View Rescue Centers</title>
                ...
                <section class="content">
                    <div class="box box-info">
                        <div class="box-header">
                            <h3 class="box-title">Rescue Center Table</h3>
                        </div><!-- /.box-header -->
                        <div class="box-body">
                            <table id="warning_table" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    @foreach($rescuecenters as $rescuecenters)
                                    <tr>
                                        <td>{{$rescuecenters->id}}</td>
                                        <td>{{$rescuecenters->name}}</td>
                                        <td>{{$rescuecenters->telephone}}</td>
                                        <td>{{$rescuecenters->type}}</td>
                                        <td><a class="btn btn-info" href="<?php echo 'rescuecenter/'.$rescuecenters->id ?>">View</a></td>
                                    </tr>
                                    @endforeach
                                </tbody>                                
                            </table>
