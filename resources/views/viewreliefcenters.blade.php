...
<html>
    <head>
        ...
        <title>Rescuer | View Releief Centers</title>
    ...
    <body class="hold-transition skin-blue sidebar-mini">
        ...
        <div class="wrapper">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="active treeview">
                            ...
                            <ul class="treeview-menu">
                                ...
                                <li class="active"><a href="/viewwarnings"><i class="fa fa-circle-o"></i> View All Warnings</a></li>
                ...
                <section class="content">
                    <div class="box box-info">
                        <div class="box-header">
                            <h3 class="box-title">Relief Center Table</h3>
                        </div><!-- /.box-header -->
                        <div class="box-body">
                            <table id="warning_table" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    @foreach($reliefcenters as $releifcenter)
                                    <tr>
                                        <td>{{$releifcenter->id}}</td>
                                        <td>{{$releifcenter->address}}</td>
                                        <td>{{$releifcenter->lat}}</td>
                                        <td>{{$releifcenter->lan}}</td>
                                        <td>{{$releifcenter->capacity}}</td>
                                        <td>{{$releifcenter->current_amount}}</td>
                                        <td><a class="btn btn-info" href="<?php echo 'reliefcenter/'.$releifcenter->id ?>">Update</a></td>
                                    </tr>
                                    @endforeach
                                </tbody>                                
                            </table>
                    ...
                    <div class="box box-danger">
                        <div class="box-header with-border">
                            <h3 class="box-title">Relief Center Map</h3>
                        </div><!-- /.box-header -->
                        <!-- form start -->
                        <div id="map">
            ...
            <footer class="main-footer">
                ...
                <strong>Copyright &copy; 2014-2016 <a href="http://almsaeedstudio.com">Titans</a>.</strong> All rights reserved.
            </footer>
