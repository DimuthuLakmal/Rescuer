...
<html>
    <head>
        ...
        <title>Rescuer | Add Warnings</title>
            ...
            <div class="content-wrapper">
                ...
                <section class="content">
                    ...
                    <div class="box box-info">
                        ...
                        <!-- form start -->
                        <form class="form-horizontal" action="/warnings" method="POST">
                            ...
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control pull-right" id="reservationtime" name="startandendtime" value="{{ old('startandendtime') }}">
                                    </div>
                                </div>
                                <div class="form-group">
